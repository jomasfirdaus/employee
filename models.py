...
class Employee(models.Model):
    ...
    munisipiu = models.ForeignKey(Munisipiu, on_delete=models.CASCADE, null=True, blank=True, related_name="Employeemunisipiu")
    postu = models.ForeignKey(Postu, on_delete=models.CASCADE, null=True, blank=True, related_name="Employeepostu")
    suku = models.ForeignKey(Suku, on_delete=models.CASCADE, null=True, blank=True, related_name="Employeesuku")
